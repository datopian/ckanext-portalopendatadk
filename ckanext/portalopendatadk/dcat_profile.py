    ...
    def graph_from_dataset(self, dataset_dict, dataset_ref):
        ...
        g.add(
            (
                ...
                DCAT.landingPage,
                URIRef(
                    "{frontend_site_url}/{organization_name}/{dataset_name}".format(
        ...
        for theme in themes:
            theme_label = DATA_THEME_LABELS.get(theme, {}).get("pref_label_da", theme)
            theme_uri = URIRef(DATA_THEME_BASE_URI + theme)

            g.add((theme_uri, RDF.type, SKOS.Concept))
            g.add((theme_uri, SKOS.prefLabel, Literal(theme_label, lang="da")))
        ...
        #                theme_uri,
        #                SKOS.prefLabel,
        #                Literal(DATA_THEME_LABELS[theme_name]['pref_label_da'], lang='da'),
        #            )
        #        )
        #        # g.add(
        #        #    (
