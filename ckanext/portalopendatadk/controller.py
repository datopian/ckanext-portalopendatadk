        ...
        if request.method == "POST":
            ...
            if user_obj:
                try:
                    ...
                    h.flash_error(_("Could not send reset link: %s") % str(e))
...
class DCATController(BaseController):
    def read_catalog(self, _format=None):
        ...
        try:
            return toolkit.get_action("dcat_catalog_show")(
    ...
    def documentation_download(self, id, resource_id, filename=None):
        ...
        if "http" in documentation:
            ...
            if "s3filestore" not in ckan_plugins:
                ...
                content_type, content_enc = mimetypes.guess_type(documentation)
                ...
                key_path = os.path.join("resources", resource_id, munged_documentation)
